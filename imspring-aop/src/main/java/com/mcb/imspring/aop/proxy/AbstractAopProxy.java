...
public abstract class AbstractAopProxy implements AopProxy{
    ...
    protected Object doInvoke(Object o, Method method, Object[] args) throws Throwable {
        ...
        List<Advisor> eligibleAdivors = findEligibleAdivors(this.advised.getAdvisors(), method, o);
        if (!eligibleAdivors.isEmpty()) {
            ...
            logger.debug("use aop proxy enhance bean: [{}]，method: [{}]，advices: {}", o.getClass().getSimpleName(), method.getName(), adviceInfos);
            ...
            ReflectiveMethodInvocation invocation = new ReflectiveMethodInvocation(this.advised.getTargetSource().getTarget(),
                    this.advised.getTargetSource().getProxy(), method, args, eligibleAdivors);
